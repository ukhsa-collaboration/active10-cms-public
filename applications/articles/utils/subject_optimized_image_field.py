...
from .image import image_optimizer


# This is rewrite of https://github.com/agusmakmun/django-image-optimizer/blob/master/image_optimizer/fields.py
# only change - other base class
class SubjectOptimizedImageField(SubjectImageField):
    ...
    def save_form_data(self, instance, data):
        ...
        updating_image = True if data and getattr(instance, self.name) != data else False  # noqa: SIM210
    ...
    def formfield(self, **kwargs):
        d = kwargs
        return super(SubjectOptimizedImageField, self).formfield(**d)  # noqa: UP008
